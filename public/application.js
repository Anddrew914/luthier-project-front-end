...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://luthier-api.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onAddInstrument = function onAddInstrument(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);

	  api.addInstrument(data).then(ui.addInstrumentSuccess).catch(ui.addInstrumentFailure);
	};

	var onViewInstruments = function onViewInstruments() {
	  event.preventDefault();
	  api.viewInstruments() // this returns an object that gets passed
	  .then(ui.viewInstrumentsSuccess).catch(ui.viewInstrumentsFailure);
	};

	var onDeleteInstrument = function onDeleteInstrument(event) {
	  // const data = getFormFields(this)
	  var instrumentPostId = event.target.dataset.id;
	  event.preventDefault();
	  api.deleteInstrument(instrumentPostId) // this returns an object that gets passed
	  .then(ui.deleteInstrumentSuccess).catch(ui.deleteInstrumentFailure);
	};

	var onEditInstrument = function onEditInstrument(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.editInstrument(data).then(ui.editInstrumentSuccess).catch(ui.editInstrumentFailure);
	};

	var onRevealSignUp = function onRevealSignUp() {
	...
	var onRevealSignIn = function onRevealSignIn() {
	...
	var onRevealChangePassword = function onRevealChangePassword() {
	...
	var onRevealAddInstrument = function onRevealAddInstrument() {
	...
	var onRevealEdit = function onRevealEdit() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var addInstrument = function addInstrument(data) {
	  return $.ajax({
	...
	var viewInstruments = function viewInstruments(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/instruments/',
	    method: 'GET',
	    headers: {
	...
	var deleteInstrument = function deleteInstrument(instrumentPostId) {
	  return $.ajax({
	...
	var editInstrument = function editInstrument(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var showInstrumentsTemplate = __webpack_require__(13);
	var api = __webpack_require__(10);
	var getFormFields = __webpack_require__(9);

	var refreshInstrumentDiv = function refreshInstrumentDiv() {

	  api.viewInstruments() // this returns an object that gets passed
	  .then(viewInstrumentsSuccess);
	  var showInstrumentsHtml = showInstrumentsTemplate({ instruments: store.instruments });
	...
	var addInstrumentSuccess = function addInstrumentSuccess(data) {
	  $('div.error-handling').text('Instrument Created');
	  refreshInstrumentDiv();
	  document.getElementById('add-instrument').reset();
	};

	var addInstrumentFailure = function addInstrumentFailure(addInstrumentSuccess) {
	  $('div.error-handling').text('Add instrument error');
	};

	var viewInstrumentsSuccess = function viewInstrumentsSuccess(data) {
	  store.instruments = data.instruments;
	  var showInstrumentsHtml = showInstrumentsTemplate({ instruments: data.instruments });
	...
	var viewInstrumentsFailure = function viewInstrumentsFailure(data) {};

	var deleteInstrumentSuccess = function deleteInstrumentSuccess(data) {
	  refreshInstrumentDiv();
	};

	var deleteInstrumentFailure = function deleteInstrumentFailure(data) {
	  $('div.error-handling').text('Delete instrument error');
	};

	var editInstrumentSuccess = function editInstrumentSuccess(data) {
	  refreshInstrumentDiv();
	};

	var editInstrumentFailure = function editInstrumentFailure(data) {
	...
	module.exports = {
	  ...
	  addInstrumentSuccess: addInstrumentSuccess,
	  addInstrumentFailure: addInstrumentFailure,
	  viewInstrumentsSuccess: viewInstrumentsSuccess,
	  viewInstrumentsFailure: viewInstrumentsFailure,
	  deleteInstrumentSuccess: deleteInstrumentSuccess,
	  deleteInstrumentFailure: deleteInstrumentFailure,
	  editInstrumentSuccess: editInstrumentSuccess,
	  editInstrumentFailure: editInstrumentFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <!-- "
	    + ((stack1 = container.invokePartial(__webpack_require__(33),depth0,{"name":"partial","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + " -->\n\n  <article class=\"instruments-article\">\n    <h2>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.instrument_type : stack1), depth0))
	    + "</h2>\n    <h3>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
	    + " dollars per month</h3>\n    <h4>Instrument id: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "</h4>\n    <p>My most recent completed repair was of a late 1800 's violin from Czecheslovakia. The bottom block was crack and needed replacing, the sound post had been glued in (!) with what must have been tite-bond. </p>\n    <img src=\"https://reverb-res.cloudinary.com/image/upload/s--J6Vh4L2A--/a_exif,c_limit,e_unsharp_mask:80,f_auto,fl_progressive,g_south,h_620,q_90,w_620/v1455054873/oe32oqj7qovhlda7gc0b.jpg\" width=\"500\"><br>\n        <!-- <input id=\"edit-instrument\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"btn btn-default delete-hb\" name=\"submit\" value=\"Edit Instrument\"> -->\n        <input id=\"delete-instrument\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"btn btn-default delete-hb\" name=\"submit\" value=\"Delete Instrument\">\n  </article>\n <!-- Developers, why are we using data-id and not just id? -->\n<!-- <ul><h1 data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"> <small><li>"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "<li> Instrument_type: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.instrument_type : stack1), depth0))
	    + " </small></h1>\n  <div> -->\n    <!-- "
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.book : depth0)) != null ? stack1.description : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + " -->\n    <!-- <li> <button class=\"btn btn-default remove-instrument\">Remove instrument</button>\n  </div>\n</ul>\n";
	  ...
	  return "\n    <li>  "
	    ...
	    return "    <li>  No description.\n    ";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.instruments : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</ul> -->\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "5196c29f932e0a2d114b727ec14c961f.jpg";
